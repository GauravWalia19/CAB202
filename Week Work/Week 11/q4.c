...
*/
#define CPU_SPEED 8000000.0          // TODO Use the clock speed we compile against...
...
void init_hardware(void) {
    ...
    // running!
    // TODO
	//taken from slide 28 of lecture
	UCSR1B |= (1 << TXCIE1); //Tx
    // Set the UART prescaler so that we get the desired baud rate
    // TODO
	//Taken from lecture demo uart1 line 110
	UBRR1 = BAUD_PRESCALER;
    // Enable transmission of UART data
    // TODO
	//Taken from lecture demo uart1 line 111
	UCSR1B |= (1 << TXEN1) | (1 << RXEN1);
    // Set the frame format to:
	//pretty much show how to do this on slide 35
    // - Asynchronous normal mode //bit set to 0 for this mode so leave unchanged (lecture slides)
    // - 8 data bits //set below
    // - 1 stop bit  //default is 1 bit so leave unchanged (lecture slides)
    // - No parity bits  //already set by default ( 0  0 ) (lecture slides) 
    // TODO
