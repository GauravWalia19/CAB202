...
unsigned char answer_7(unsigned char arg0, int arg1) {
	char switchValue = (arg0 >> arg1) & 1;
    return switchValue;
}

unsigned char answer_8(unsigned char arg0, int arg1, int arg2) {
	arg0 |= (1 << arg1); //set the bit corresponding to arg1
	arg0 ^= 1 << 0; //toggle everything
	arg0 ^= 1 << 1;
	arg0 ^= 1 << 2;
	arg0 ^= 1 << 3;
	arg0 ^= 1 << 4;
	...
	arg0 ^= 1 << 6;
	arg0 ^= 1 << 7;
	char switchValue = (arg0 >> arg2) & 1; //read in the value of bit numbered arg2
    return switchValue; //return this value
}
